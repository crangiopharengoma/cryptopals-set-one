//! This is directly copied from the crate sha1_smol
//! Challenge 29 requires modifying this code to create a hasher with a non-standard starting state
//!
//!
...
impl Sha1 {
    ...
    /// Creates a fresh sha1 hash object with from a known state
    ///
    /// Added to sha1_smol lib to satisfy requirements for cryptopals challenge 29
    pub fn new_from_state(state: [u32; 5], len: u64) -> Sha1 {
        Sha1 {
